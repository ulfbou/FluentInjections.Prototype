...
namespace FluentInjections.Extensions
{
    public static class AsyncEnumerableExtensions
    {
        ...
        public static async Task<T[]> ToArray<T>(this IAsyncEnumerable<T> source, CancellationToken cancellationToken = default)
        {
            var list = await source.ToEnumerable(cancellationToken).ConfigureAwait(false);
            return list.ToArray();
        }
