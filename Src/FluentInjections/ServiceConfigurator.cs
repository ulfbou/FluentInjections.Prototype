...
namespace FluentInjections
{
    internal class ServiceConfigurator : ComponentConfiguratorBase<IServiceComponent>, IServiceConfigurator
    {
        ...
        {
            return new ServiceComponentBuilder<TContract, IComponentRegistration<IServiceComponent, TContract>>(registration, _loggerFactory);
        }
        protected override IComponentRegistration<IServiceComponent, object> CreateRegistration(Type contractType, string alias)
        {
            return new ServiceComponentRegistration<object>
            {
        ...
        {
            return new ServiceComponentRegistration<TContract>
            {
